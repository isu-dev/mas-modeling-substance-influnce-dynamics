...
public class ReLogoPatch extends BasePatch{
	...
	/**
	 * Sprouts (makes) a number of new advertisings and then executes a set of commands on the
	...
	public AgentSet<druginfluence.relogo.Advertising> sproutAdvertisings(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Advertising> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"Advertising");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Advertising")
	public AgentSet<druginfluence.relogo.Advertising> sproutAdvertisings(int number) {
		return sproutAdvertisings(number,null);
	}
	...
	/**
	 * Sprouts (makes) a number of new civilians and then executes a set of commands on the
	 * created civilians.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<druginfluence.relogo.Civilian> sproutCivilians(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Civilian> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"Civilian");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Civilian")
	public AgentSet<druginfluence.relogo.Civilian> sproutCivilians(int number) {
		return sproutCivilians(number,null);
	}
	...
	/**
	 * Sprouts (makes) a number of new dealers and then executes a set of commands on the
	 * created dealers.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<druginfluence.relogo.Dealer> sproutDealers(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Dealer> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"Dealer");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Dealer")
	public AgentSet<druginfluence.relogo.Dealer> sproutDealers(int number) {
		return sproutDealers(number,null);
	}
	...
	/**
	 * Sprouts (makes) a number of new officers and then executes a set of commands on the
	 * created officers.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<druginfluence.relogo.Officer> sproutOfficers(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Officer> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"Officer");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Officer")
	public AgentSet<druginfluence.relogo.Officer> sproutOfficers(int number) {
		return sproutOfficers(number,null);
	}
	...
	public AgentSet<druginfluence.relogo.UserTurtle> sproutUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.UserTurtle")
	public AgentSet<druginfluence.relogo.UserTurtle> sproutUserTurtles(int number) {
