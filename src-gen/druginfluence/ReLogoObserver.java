...
public class ReLogoObserver extends BaseObserver{
	...
	/**
	 * Makes a number of randomly oriented advertisings and then executes a set of commands on the
	...
	public AgentSet<druginfluence.relogo.Advertising> createAdvertisings(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Advertising> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Advertising");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Advertising")
	public AgentSet<druginfluence.relogo.Advertising> createAdvertisings(int number) {
		return createAdvertisings(number,null);
	}

	/**
	 * Makes a number of uniformly fanned advertisings and then executes a set of commands on the
	 * created advertisings.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Advertising")
	public AgentSet<druginfluence.relogo.Advertising> createOrderedAdvertisings(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Advertising> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Advertising");
		for (Turtle t : createResult){
			if (t instanceof druginfluence.relogo.Advertising){
				result.add((druginfluence.relogo.Advertising)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Advertising")
	public AgentSet<druginfluence.relogo.Advertising> createOrderedAdvertisings(int number) {
		return createOrderedAdvertisings(number,null);
	}
	...
	public AgentSet<druginfluence.relogo.Advertising> advertisings(){
		...
		for (Object e : this.getContext().getObjects(druginfluence.relogo.Advertising.class)) {
	...
	public AgentSet<druginfluence.relogo.Advertising> advertisingsOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"advertising")){
			if (t instanceof druginfluence.relogo.Advertising)
			result.add((druginfluence.relogo.Advertising)t);
		}
		return result;
	...
	public AgentSet<druginfluence.relogo.Advertising> advertisingsOn(Turtle t){
		AgentSet<druginfluence.relogo.Advertising> result = new AgentSet<druginfluence.relogo.Advertising>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"advertising")){
	...
	/**
	 * Makes a number of randomly oriented civilians and then executes a set of commands on the
	 * created civilians.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<druginfluence.relogo.Civilian> createCivilians(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Civilian> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Civilian");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Civilian")
	public AgentSet<druginfluence.relogo.Civilian> createCivilians(int number) {
		return createCivilians(number,null);
	}

	/**
	 * Makes a number of uniformly fanned civilians and then executes a set of commands on the
	 * created civilians.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Civilian")
	public AgentSet<druginfluence.relogo.Civilian> createOrderedCivilians(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Civilian> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Civilian");
		for (Turtle t : createResult){
			if (t instanceof druginfluence.relogo.Civilian){
				result.add((druginfluence.relogo.Civilian)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Civilian")
	public AgentSet<druginfluence.relogo.Civilian> createOrderedCivilians(int number) {
		return createOrderedCivilians(number,null);
	}
	...
	public AgentSet<druginfluence.relogo.Civilian> civilians(){
		...
		for (Object e : this.getContext().getObjects(druginfluence.relogo.Civilian.class)) {
	...
	public AgentSet<druginfluence.relogo.Civilian> civiliansOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"civilian")){
			if (t instanceof druginfluence.relogo.Civilian)
			result.add((druginfluence.relogo.Civilian)t);
		}
		return result;
	...
	public AgentSet<druginfluence.relogo.Civilian> civiliansOn(Turtle t){
		AgentSet<druginfluence.relogo.Civilian> result = new AgentSet<druginfluence.relogo.Civilian>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"civilian")){
	...
	/**
	 * Makes a number of randomly oriented dealers and then executes a set of commands on the
	 * created dealers.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<druginfluence.relogo.Dealer> createDealers(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Dealer> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Dealer");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Dealer")
	public AgentSet<druginfluence.relogo.Dealer> createDealers(int number) {
		return createDealers(number,null);
	}

	/**
	 * Makes a number of uniformly fanned dealers and then executes a set of commands on the
	 * created dealers.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Dealer")
	public AgentSet<druginfluence.relogo.Dealer> createOrderedDealers(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Dealer> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Dealer");
		for (Turtle t : createResult){
			if (t instanceof druginfluence.relogo.Dealer){
				result.add((druginfluence.relogo.Dealer)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Dealer")
	public AgentSet<druginfluence.relogo.Dealer> createOrderedDealers(int number) {
		return createOrderedDealers(number,null);
	}
	...
	public AgentSet<druginfluence.relogo.Dealer> dealers(){
		...
		for (Object e : this.getContext().getObjects(druginfluence.relogo.Dealer.class)) {
	...
	public AgentSet<druginfluence.relogo.Dealer> dealersOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"dealer")){
			if (t instanceof druginfluence.relogo.Dealer)
			result.add((druginfluence.relogo.Dealer)t);
		}
		return result;
	...
	public AgentSet<druginfluence.relogo.Dealer> dealersOn(Turtle t){
		AgentSet<druginfluence.relogo.Dealer> result = new AgentSet<druginfluence.relogo.Dealer>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"dealer")){
	...
	/**
	 * Makes a number of randomly oriented officers and then executes a set of commands on the
	 * created officers.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<druginfluence.relogo.Officer> createOfficers(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Officer> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.crt(number,closure,"Officer");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Officer")
	public AgentSet<druginfluence.relogo.Officer> createOfficers(int number) {
		return createOfficers(number,null);
	}

	/**
	 * Makes a number of uniformly fanned officers and then executes a set of commands on the
	 * created officers.
	 * 
	 * @param number
	 *            a number
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Officer")
	public AgentSet<druginfluence.relogo.Officer> createOrderedOfficers(int number, Closure closure) {
		AgentSet<druginfluence.relogo.Officer> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.cro(number,closure,"Officer");
		for (Turtle t : createResult){
			if (t instanceof druginfluence.relogo.Officer){
				result.add((druginfluence.relogo.Officer)t);
			}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.Officer")
	public AgentSet<druginfluence.relogo.Officer> createOrderedOfficers(int number) {
		return createOrderedOfficers(number,null);
	}
	...
	public AgentSet<druginfluence.relogo.Officer> officers(){
		...
		for (Object e : this.getContext().getObjects(druginfluence.relogo.Officer.class)) {
	...
	public AgentSet<druginfluence.relogo.Officer> officersOn(Patch p){
		...
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),this,"officer")){
			if (t instanceof druginfluence.relogo.Officer)
			result.add((druginfluence.relogo.Officer)t);
		}
		return result;
	...
	public AgentSet<druginfluence.relogo.Officer> officersOn(Turtle t){
		AgentSet<druginfluence.relogo.Officer> result = new AgentSet<druginfluence.relogo.Officer>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),this,"officer")){
	...
	public AgentSet<druginfluence.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.UserTurtle")
	public AgentSet<druginfluence.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.UserTurtle")
	public AgentSet<druginfluence.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<druginfluence.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("druginfluence.relogo.UserTurtle")
	public AgentSet<druginfluence.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<druginfluence.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(druginfluence.relogo.UserTurtle.class)) {
	...
	public AgentSet<druginfluence.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(druginfluence.relogo.UserLink.class)) {
	...
	public druginfluence.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (druginfluence.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
